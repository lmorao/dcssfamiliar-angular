export const weapon_types = {
  "dagger": {
   ...
   "quick blade": {'category': "short_blades", "name": 'quick_blade', 'damage': '5', 'hit':'+6', 'speed': '7','ohms':'little', 'thms':'little','damage_type':"piercing", 'prob':'2'},
   "short sword": {'category': "short_blades", "name": 'short_sword', 'damage': '6', 'hit':'+4', 'speed': '11','ohms':'little', 'thms':'little','damage_type':"piercing", 'prob':10},
   "rapier": {'category': "short_blades", "name": 'rapier', 'damage': '8', 'hit':'+4', 'speed': '12','ohms':'little', 'thms':'little','damage_type':"piercing", 'prob':10},

   "falchion": {'category': "long_blades", "name": 'falchion', 'damage': '7', 'hit':'+2', 'speed': '13','ohms':'little', 'thms':'little','damage_type':"slicing", 'prob':10},
   "long sword": {'category': "long_blades", "name": 'long_sword', 'damage': '9', 'hit':'+1', 'speed': '14','ohms':'little', 'thms':'little','damage_type':"slicing", 'prob':10},
   ...
   "triple sword": {'category': "long_blades", "name": 'triple_sword', 'damage': '17', 'hit':'-4', 'speed': '19','ohms':'little', 'thms':'little','damage_type':"slicing", 'prob':2},
